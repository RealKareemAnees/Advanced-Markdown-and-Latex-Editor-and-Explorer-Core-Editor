/**
 * src/engine/entities-store/embedding/EmbeddingEntity.ts
 * Embedding block entity implementation
 */
 ...
 */
export class EmbeddingEntity extends BlockEntityAbstract<URL, null> {
    ...
    constructor(data: URL = new URL("about:blank"), options: null = null) {
        super(BlockTypesEnum.EMBEDDING, data, options);
        this._TYPE = BlockTypesEnum.EMBEDDING;
        this._HTML_ELEMENT = getDocument().createElement("iframe");
    }

    /**
     * Parses the data for the embedding entity
