/**
 * src/engine/entities-store/oi/OiEntity.ts
 * Ordered List Item (OI) block entity implementation
 */
...
/**
 * OI (Ordered List Item) block entity
 */
export class OiEntity extends BlockEntityAbstract<string, null> {
    ...
    constructor(data: string = "", options: null = null) {
        super(BlockTypesEnum.OI, data, options);
        this._TYPE = BlockTypesEnum.OI;
    }

    /**
     * Parses the data for the OI entity
